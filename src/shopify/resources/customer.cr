...
# TODO fixture exports
# class ExportCustomerSomething
#   def self.from_json(json : String) : Shopify::Customer
#     File.open("./spec/fixtures/customer.json", "w") { |f| f.write(json) }
#     Shopify::Customer.from_json json
#   end
# end
